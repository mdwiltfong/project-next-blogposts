...
//Here we are calling these variables to be attached to their respective input fields. 

//Once we onChange is ran, it will change the state of the respective hook, which will then be used to form the post request. 
